...
})
{
  ...
  <DropdownMenuContent align="end">
    <DropdownMenuItem asChild>
      <button className="w-full cursor-pointer" onClick={() => setTheme("light")}>
        Light
      </button>
    </DropdownMenuItem>
    <DropdownMenuItem asChild>
      <button className="w-full cursor-pointer" onClick={() => setTheme("dark")}>
        Dark
      </button>
    </DropdownMenuItem>
    <DropdownMenuItem asChild>
      <button className="w-full cursor-pointer" onClick={() => setTheme("system")}>
        System
      </button>
    </DropdownMenuItem>
  </DropdownMenuContent>
